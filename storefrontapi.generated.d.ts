...
export type StoreProductFragment = Pick<
  StorefrontAPI.Product,
  | 'id'
  | 'handle'
  | 'title'
...
export type CartCreateMutation = {
  cartCreate?: StorefrontAPI.Maybe<{
    ...
    userErrors: Array<Pick<StorefrontAPI.CartUserError, 'message'>>;
  }>;
};
...
export type PdpProductQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type PdpProductQuery = {
